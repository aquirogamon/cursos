...
return table_all_object.sort! { |a,b| a[:object_name] <=> b[:object_name] }.select{|interfaces| interfaces[:object_name].exclude?("4G")}
end
...
table_object_group_detail_sevone = object_group_detail_sevone(90)
...
user = "reportkpi"
password = "Cl4r0peru51"
url = "http://172.19.216.90/api/v2/objectgroups/90/members"
